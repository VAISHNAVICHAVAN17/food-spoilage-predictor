...
const Prediction = require('../models/Prediction'); // Add your Prediction mongoose model

// Default shelf life etc and helper functions ...
...
router.post('/', async (req, res) => {
  try {
    ...
    // Compute storage density and contributions, risk, and adjustments (same as your code)
    const now = new Date();
    ...
    else if (totalPct < -0.6) totalPct = -0.6;
